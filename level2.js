...
function idleAnimation(){
    ...
    boy.src = "boy ninja/Idle__00"+idleImageNumber+".png";
}
...
function runAnimation() {
    ...
    boy.src = "boy ninja/Run__00"+runImageNumber+".png";
}
...
function jumpAnimation() {
    ...
    boy.src = "boy ninja/Jump__00"+jumpImageNumber+".png";
}
...
function createBoxes() {
    ...
    for(var i = 0;  i< 20; i++)  {
            ...
            if(i>=6){
                boxMarginLeft = boxMarginLeft + 650;
...
function boxAnimation(){
    for(var i = 0; i<20 ; i++){
        ...
        // alert(newMarginLeft);
        if (newMarginLeft < 170 & newMarginLeft > 80 & boyMarginTop > 405 ) {
            clearInterval(jumpAnimationNumber);
...
function DeadAnimation(){
    ...
    var deadAnimatioId = document.getElementById("boy");
    deadAnimatioId.style.marginTop = "480px";
    if (deadAnimationNumber == 10) {
        deadAnimationNumber = 9;
    }
     deadAnimatioId.src = "boy ninja/Dead__00"+deadAnimationNumber+".png";
     if (u < 1500) {
